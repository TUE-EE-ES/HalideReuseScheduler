...
#define XROWS 2048
#define YCOLUMNS (76800/32)             // before y shift
#define YCOLUMNS2 (YCOLUMNS + 1024/32)  // after y shift
#define YCOLUMNS3 (YCOLUMNS * 2/3)      // before spf
#define YCOLUMNS8 (YCOLUMNS * 8/3)      // before mlhalftone
#define YCOLUMNS24 (YCOLUMNS * 8)   // after resolution conversion
#define X 4*XROWS*YCOLUMNS   
#define it 1
