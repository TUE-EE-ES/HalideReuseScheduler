...
//    fprintf(stderr, "       %d %d\n", input.width(), input.height());
    ...
    double best_man,best_auto;

    best_man = benchmark(timing_iterations, 1, [&]() {
    ...
    #ifndef NO_AUTO_SCHEDULE
    best_auto = benchmark(timing_iterations, 1, [&]() {
    ...
    #endif
    std::cout<<"Manually-tuned time:"<< best_man*1000 <<"ms"<<std::endl;;
    std::cout<<"Auto-scheduled time:"<< best_auto*1000 <<"ms"<<std::endl;;
