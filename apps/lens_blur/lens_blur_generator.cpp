...
public:
    ...
    void generate() {
        ...
        if (auto_schedule) {
            ...
            left_im.dim(0).set_bounds_estimate(0, 192);
            left_im.dim(1).set_bounds_estimate(0,320);
            left_im.dim(2).set_bounds_estimate(0, 3);
            right_im.dim(0).set_bounds_estimate(0, 192);
            right_im.dim(1).set_bounds_estimate(0, 320);
